    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <motion.p className="mt-2 md:mt-4 text-base md:text-lg" variants={slideInUp}>
            Delivering high-performance, secure, and scalable cross-platform mobile applications tailored to your business needs.
          </motion.p>
        </div>
      </motion.section>
      ...
      <main className="container mx-auto px-6 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl md:text-4xl font-extrabold text-gray-800 mb-4 md:mb-6">Our Cross-Platform App Development Services</h2>
        ...
        <section>
          ...
          <p className="text-base md:text-lg text-gray-600 mb-4">
            Ready to elevate your business with a custom cross-platform app? Contact us today to discuss your project!
          </p>
          <motion.button
